...
(cl:defmethod cl:initialize-instance :after ((m <person_data>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'person_data)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sus2-msg:<person_data> is deprecated: use sus2-msg:person_data instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <person_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sus2-msg:name-val is deprecated.  Use sus2-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'age-val :lambda-list '(m))
(cl:defmethod age-val ((m <person_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sus2-msg:age-val is deprecated.  Use sus2-msg:age instead.")
  (age m))

(cl:ensure-generic-function 'color-val :lambda-list '(m))
(cl:defmethod color-val ((m <person_data>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sus2-msg:color-val is deprecated.  Use sus2-msg:color instead.")
  (color m))
